...
-- The API talks to Supabase using the service-role key. Supabase's SQL
-- editor doesn't always auto-grant privileges on tables created by hand
-- (only tables created through the dashboard UI get default grants), so
-- without this you'll hit "permission denied for table reports" even
-- though the table exists.
grant usage on schema public to service_role;
grant all privileges on public.reports to service_role;
grant all privileges on public.report_evidence to service_role;
